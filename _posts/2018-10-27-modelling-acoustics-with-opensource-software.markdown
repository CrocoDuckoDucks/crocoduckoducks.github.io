...
<ul>
	...
	<li><a href="https://evertims.github.io/" target="_blank" rel="noopener">EVERTims</a> is an open source framework for real-time auralization in architectural acoustics and virtual reality. It works with Blender, even in realtime, and it has a Python API. I never tried it, but looks very compelling!</li>
